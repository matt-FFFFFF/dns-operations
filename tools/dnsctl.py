...
def cmd_import_blocks(args, root: Path) -> int:
    ...
    lines = [
        ...
        "#",
        "# Generated: a list of Cloudflare record ids, which .gitignore excludes by",
        "# default. Commit it only for the one apply that adopts a zone -- with",
        "# `git add -f` -- then delete it. Regenerate rather than keep.",
        "",
        "locals {",
        "  imports = {",
    ]
