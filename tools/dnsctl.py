...
def cmd_import_blocks(args, root: Path) -> int:
    ...
    lines = [
        ...
        "#",
        "# Generated, never committed: it is a list of Cloudflare record ids, and",
        "# .gitignore excludes it. Regenerate it before adopting a zone, and delete",
        "# it once that zone's import has been applied.",
        "",
        "locals {",
        "  imports = {",
    ]
